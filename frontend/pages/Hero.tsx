...
const Hero = () => {
  return (
    <section
      className={`flex flex-col  justify-center bg-black items-center  w-full md:pt-24 xs:h-[45rem] md:h-[70rem] md:py-10  pb-10 `}
      id="home"
    >
        ...
        <div className="flex flex-col lg:justify-start  justify-center items-center h-full ">
          ...
          <div className="xs:mb-3 md:mb-10 xs:w-3/5 2xl:w-full ">
            ...
            <p className=" xs:text-3xl md:text-4xl  lg:text-6xl font-medium xs:space-x-2 md:space-x-3">
              <span className="word animate-blur-in animate-delay-[1.5s] text-color ">
                Welcome
              </span>
              <span className="word animate-blur-in animate-delay-[2.2s] text-color  ">
                to
              </span>
              <span className="word animate-blur-in animate-delay-[2.8s] text-color xs:-translate-x-1">
                my
              </span>

              <span className="  text-color font-[900] lg:-translate-x-0  word  animate-blur-in animate-delay-[3.2s] ">
                Portfolio
              </span>
            </p>
          </div>
